...
def get_compass_correction():
    """Serve the compass correction table for the dual-compass dashboard.

    The dashboard's True North compass uses this to convert magnetic → true heading
    client-side via JavaScript interpolation.  Returns the JSON generated by
    compass_diagnostic.py.
    """
    ...
    try:
        if os.path.exists(correction_path):
            ...
            return jsonify({'type': 'none', 'offset': 0}), 200
    except Exception as e:
